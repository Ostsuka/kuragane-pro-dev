...
const techStack = [
  ...
  { name: "PHP Laravel",   logo: "🪄", color: "text-rose-600   bg-rose-50   border-rose-200" },
  { name: "Java",          logo: "☕", color: "text-orange-700 bg-orange-50 border-orange-200" },
  { name: "Python",        logo: "🐍", color: "text-blue-700   bg-blue-50   border-blue-200" },
  { name: "MySQL",         logo: "🐬", color: "text-sky-600    bg-sky-50    border-sky-200" },
  ...
  { name: "Redis",         logo: "🔴", color: "text-red-500    bg-red-50    border-red-200" },
